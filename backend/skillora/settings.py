...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-skillora-secret-key')
...
# -----------------------------------------------------------------------
# Database — SQLite (zero-config, works immediately without any setup)
# All models including custom Skillora apps use SQLite.
# To switch to MongoDB, set USE_MONGODB=True in your .env and ensure
# MongoDB is running locally, then re-run migrations.
# -----------------------------------------------------------------------
