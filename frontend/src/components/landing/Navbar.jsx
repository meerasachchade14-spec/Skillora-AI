...
function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl border-b border-blue-100 bg-white/80 shadow-sm">
      ...
      {open && (
        <motion.div
          ...
          className="lg:hidden border-t bg-white border-blue-100"
        >
          <div className="flex flex-col gap-5 p-6">
            ...
            <Link
              to="/login"
              onClick={() => setOpen(false)}
              className="py-3 rounded-xl bg-gray-100 text-gray-700 text-center font-semibold hover:bg-gray-200 transition"
            >
              Login
            </Link>
