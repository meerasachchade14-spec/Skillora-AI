...
function UploadArea({ onUpload, uploading }) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg p-8">
      ...
      >
        {uploading ? (
          <FaSpinner className="text-7xl text-sky-500 mx-auto animate-spin" />
        ) : (
        ...
        <button
          disabled={uploading}
          className="mt-8 px-8 py-4 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition disabled:bg-gray-400"
        >
          Browse File
        </button>
